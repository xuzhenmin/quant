...
/**
 * @author zhenmin
 * @version $Id: CreatLineChart.java, v 0.1 2022-03-18 5:18 下午 xuxu Exp $$
 */
public class CreatLineChart {
     ...
     * @throws Exception
     */
    public static void CreateNewLineChartForPng(String title, String xtitle, String ytitle, String filepath,
                                                List<String> categorie, List<Serie> series, int width, int height)
        throws Exception {
    ...
    private static void setLineRender(CategoryPlot plot, boolean isShowDataLabels, boolean isShapesVisible) {
        ...
        if (isShowDataLabels) {
            ...
            renderer.setBaseItemLabelGenerator(
                new StandardCategoryItemLabelGenerator(StandardCategoryItemLabelGenerator.DEFAULT_LABEL_FORMAT_STRING,
     ...
     * 必须设置文本抗锯齿
     */
    private static void setAntiAlias(JFreeChart chart) {
     ...
     */
    //创建折线图图表
    private DefaultCategoryDataset createDataset(List<String> categorie, List<Serie> series) {
        // 标注类别
     ...
     * @throws Exception
     */
    public ChartPanel createChart(String title, String xtitle, String ytitle, List<String> categorie,
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ChartPanel chartPanel = new CreatLineChart().createChart(NO_DATA_MSG, NO_DATA_MSG, NO_DATA_MSG, categorie,
                series);
            frame.getContentPane().add(chartPanel);
            frame.setVisible(true);
            //将图片保存为png格式
            //            saveAsFile(chartPanel.getChart(),"D:\\1\\lol.png",900,500);
            //NO_DATA_MSG = "./pngs/file_" + System.currentTimeMillis() + ".png";
     ...
     * @param series
     */
    public void createChartSwing(String title, String xTitle, String yTitle, List<String> categorie,
                                 List<Serie> series) {
        try {
            final JFrame frame = new JFrame();
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setSize(2048, 640);
            frame.setLocationRelativeTo(null);

            ChartPanel chartPanel = createChart(title, xTitle, yTitle, categorie,
                series);
            frame.getContentPane().add(chartPanel);
            frame.setVisible(true);
